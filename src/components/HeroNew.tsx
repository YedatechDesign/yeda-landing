  ...
  return (
    <section className="no-pad-bottom" style={{ background: "#000F61", paddingTop: 72, paddingBottom: 0, overflow: "hidden", position: "relative" }}>
      ...
      >
        ...
        >
          Yeda היא מערכת LMS לארגונים שמרכזת ניהול למידה, הדרכות עובדים וידע ארגוני במקום אחד.
          המערכת מאפשרת ליצור תוכן עם AI, להפיץ הכשרות, לעקוב אחר ביצועים ולהפיק דוחות למנהלי משאבי אנוש, הדרכה ופיתוח ארגוני.
        </p>
