const differentiators = [
  ...
  },
  {
    ...
    desc: "מצגת? מסמך? הקלטה? ה-AI של Yeda הופך כל חומר גלם ללומדה מלאה עם שאלות, תעודה וניתוח ביצועים – תוך דקות.",
    highlight: "יצירת קורס שלוקחת שבועות – אצלנו לוקחת שעות",
  },
  {
    number: "04",
