...
const lmsFeatures = [
  ...
  { icon: "settings" as const, title: "אינטגרציות ואוטומציות", tag: "אינטגרציה", ai: false,
    subtitle: "מתממשקים לכל פלטפורמה",
    desc: "מתחברים לכל מערכת בארגון — CRM, HRIS, WhatsApp וכל פלטפורמה אחרת — כולל פיתוח חיבורי API ייעודיים בהתאמה אישית לצרכים ולאפיון של הארגון.",
    bullets: ["ממשק לכל מערכת — CRM, HRIS, WhatsApp ועוד", "פיתוח אינטגרציות ו-API בהתאמה אישית (בתשלום)", "ענפים נפרדים לכל יחידה עסקית"],
    image: null as string | null },
      ...
      >
        <div className="acc-left" style={{ display: "flex", alignItems: "center", gap: 16, flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            ...
            <Icon d={ICONS[feature.icon]} size={22} color={open ? "#000F61" : "#9A3F00"} />
          </div>
        ...
        <div className="acc-right" style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
          ...
          <div style={{
            ...
            <Icon d={ICONS.chevron} size={16} color={open ? "#000F61" : "#36405E"} />
          </div>
        </div>
      </button>
