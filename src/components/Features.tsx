...
const lmsFeatures = [
  ...
  { Icon: IconChart,       title: "מעקב התקדמות וניתוח ביצועים",   desc: "דשבורד מנהלים בזמן אמת: מי צפה, מי השלים, מה הציון, איפה יש פערים. קבלו החלטות מבוססות נתונים.",                    bg: "#F08700" },
  { Icon: IconCertificate, title: "תעודות והסמכות אוטומטיות",       desc: "בסיום הכשרה – עובדים מקבלים תעודה מותאמת אישית אוטומטית. מינהל הסמכות דיגיטלי ומלא.",                              bg: "#F08700" },
  { Icon: IconVideo,       title: "דיגיטלי, Zoom וכיתה – במקום אחד", desc: "ניהול אחיד של כל סוגי ההדרכה: לומדות דיגיטליות, שידורים חיים, מפגשים פיזיים ולוח שנה מובנה.",                      bg: "#000F61" },
  ...
  { Icon: IconBook,        title: "ספרייה ארגונית",                 desc: "מאגר ידע מרכזי לכל הארגון – מסמכים, נהלים, סרטונים, מצגות. נגיש, מאורגן ותמיד מעודכן.",                              bg: "#F08700" },
  { Icon: IconBot,         title: "עוזר AI ארגוני",                 desc: "צ'אטבוט AI שמאומן על חומרי הארגון שלכם. עובדים שואלים שאלות ומקבלים תשובות מדויקות.",                                bg: "#F08700" },
...
const labsFeatures = [
  { Icon: IconZap,          title: "יצירת לומדות AI בדקות",         desc: "מעלים חומר גלם – מצגת, מסמך, הקלטה – והמערכת יוצרת לומדה אינטראקטיבית מלאה עם חידונים.",                           bg: "#000F61" },
  { Icon: IconVideo,        title: "סרטוני הסבר AI",                desc: "יצירת סרטוני הדרכה מקצועיים עם דוברים AI, תמלול אוטומטי, כתוביות ותרגום לשפות שונות.",                               bg: "#F08700" },
  ...
  { Icon: IconMic,          title: "תמלול, תרגום ווויס-אובר",       desc: "תמלול אוטומטי לסרטונים קיימים, תרגום לעשרות שפות ושכפול קול ל-AI voice-over – אוטומטי.",                             bg: "#F08700" },
  ...
  { Icon: IconBot,          title: "סוכן AI אישי לכל עובד",         desc: "כל עובד מקבל סוכן AI אישי שמלווה אותו בתהליך הלמידה, עונה על שאלות ומתאים את הקצב.",                                bg: "#F08700" },
];
